...
ssh $SSH_OPTS $ROOT_USERHOST '
    ...
    *)
    ...
    apt-get -y install ncurses-dev rsync cdbs elinks python-simplejson rpm reprepro tofrodos zip unzip ant $java_package htmldoc plotutils transfig graphviz docbook-utils texlive-fonts-recommended gs-gpl python2.5 erlang-dev python-pexpect openssl fakeroot git-core m4 xmlto mercurial
