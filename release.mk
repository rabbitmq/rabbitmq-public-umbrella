...
.PHONY: rabbitmq-server-standalone-packaging
rabbitmq-server-standalone-packaging: rabbitmq-server-srcdist
	$(MAKE) -C rabbitmq-server/packaging/standalone dist VERSION=$(VERSION)
	cp rabbitmq-server/packaging/standalone/rabbitmq-server-standalone-*.tar.gz $(SERVER_PACKAGES_DIR)
